...
import com.asteristired.arthurscandles.BlockEntities.RagingCandleBlockEntity;
...
public class RagingCandle extends BlockWithEntity {
    ...
    protected RagingCandle(Settings settings) {
    ...
    public @Nullable BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new RagingCandleBlockEntity(pos, state);
    }

    @Override
    public @Nullable <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return checkType(type, ModBlockEntities.RAGING_CANDLE,
